...
data class AiEndpointConfig(
    ...
    companion object {
        ...
        val DEFAULT_EMOTION_PROMPT_TEMPLATE = """
            ...
            9. "bodyStressSignals"：身体压力、睡眠、能量、胸口紧、肩颈紧等线索；没有就返回空数组。
            10. "riskNotes"：安全风险观察和现实支持提醒；没有高风险时可返回空数组。
            11. "summary"：整合成一段专业心理画像，覆盖触发机制、认知/需求/关系线索、防御或应对方式、资源优势。
            12. "suggestions"：3 到 6 条具体、可执行、低负担的改善建议，优先包括记录触发点、需求命名、边界练习、身体稳定、现实支持等。
            13. "safetyFlag"：仅在出现明显自伤、自杀、伤人、极端绝望或现实安全高风险信号时返回 true，否则 false。
